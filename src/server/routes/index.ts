...
router.delete("/cidades/:id", ensureAuthenticated, CidadesController.DeletedValidation, CidadesController.deleteById);
...
router.get("/logout", ensureAuthenticated, UsuariosController.logout);
